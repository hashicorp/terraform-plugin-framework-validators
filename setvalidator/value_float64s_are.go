...
func ValueFloat64sAre(elementValidators ...validator.Float64) validator.Set {
...
func (v valueFloat64sAreValidator) ValidateSet(ctx context.Context, req validator.SetRequest, resp *validator.SetResponse) {
