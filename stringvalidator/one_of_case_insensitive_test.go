...
func TestOneOfCaseInsensitiveValidator(t *testing.T) {
	...
	for name, test := range testCases {
		...
		t.Run(fmt.Sprintf("ValidateString - %s", name), func(t *testing.T) {
			...
			stringvalidator.OneOfCaseInsensitive(test.oneOfValues...).ValidateString(context.TODO(), req, &res)
		...
		t.Run(fmt.Sprintf("ValidateParameterString - %s", name), func(t *testing.T) {
			...
			stringvalidator.OneOfCaseInsensitive(test.oneOfValues...).ValidateParameterString(context.TODO(), req, &res)
