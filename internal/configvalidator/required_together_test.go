...
func TestRequiredTogetherValidatorValidateEphemeralResource(t *testing.T) {
	t.Parallel()
...
func TestRequiredTogetherValidatorValidateAction(t *testing.T) {
	t.Parallel()
...
func TestRequiredTogetherValidatorValidateStateStore(t *testing.T) {
	t.Parallel()
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			testCase.validator.ValidateStateStore(context.Background(), testCase.req, got)
