...
func TestExactlyOneOfValidatorValidateEphemeralResource(t *testing.T) {
	t.Parallel()
...
func TestExactlyOneOfValidatorValidateAction(t *testing.T) {
	t.Parallel()
...
func TestExactlyOneOfValidatorValidateStateStore(t *testing.T) {
	t.Parallel()
