...
func AnyWithAllWarnings(validators ...statestore.ConfigValidator) statestore.ConfigValidator {
	return anyWithAllWarningsValidator{
		validators: validators,
	}
}

var _ statestore.ConfigValidator = anyWithAllWarningsValidator{}
...
func (v anyWithAllWarningsValidator) ValidateStateStore(ctx context.Context, req statestore.ValidateConfigRequest, resp *statestore.ValidateConfigResponse) {
	anyValid := false
