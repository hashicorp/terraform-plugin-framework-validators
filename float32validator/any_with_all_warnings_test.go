...
func TestAnyWithAllWarningsValidatorValidateFloat32(t *testing.T) {
	t.Parallel()
	...
	for name, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			float32validator.AnyWithAllWarnings(test.validators...).ValidateFloat32(context.Background(), request, &response)
