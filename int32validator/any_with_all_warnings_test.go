...
func TestAnyWithAllWarningsValidatorValidateInt32(t *testing.T) {
	t.Parallel()
	...
	for name, test := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			int32validator.AnyWithAllWarnings(test.validators...).ValidateInt32(context.Background(), request, &response)
