...
var _ validator.Map = valueListsAreValidator{}
...
func (v valueListsAreValidator) ValidateMap(ctx context.Context, req validator.MapRequest, resp *validator.MapResponse) {
