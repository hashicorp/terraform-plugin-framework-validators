...
var _ validator.Map = valueMapsAreValidator{}
...
func (v valueMapsAreValidator) ValidateMap(ctx context.Context, req validator.MapRequest, resp *validator.MapResponse) {
