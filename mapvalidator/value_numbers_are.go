...
var _ validator.Map = valueNumbersAreValidator{}
...
func (v valueNumbersAreValidator) ValidateMap(ctx context.Context, req validator.MapRequest, resp *validator.MapResponse) {
